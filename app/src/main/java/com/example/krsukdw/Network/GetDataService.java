package com.example.krsukdw.Network;
...
public interface GetDataService {
    ...
    Call<ArrayList<Dosen>> getDosenAll(@Path("nim_progmob") String nim_progmob);//fungsi yg akan dipanggil di app (cara 1) hasilnya: /api/progmob/dosen/72170101
//    Call<ArrayList<Dosen>> getDosenAll(@Query("nim_progmob") String nim_progmob); //(cara 2) /api/progmob/dosen?nim_progmob=72170101
    ...
    @FormUrlEncoded
    @POST("/api/progmob/mhs/createfotomhs")
    Call<DefaultResult> insert_foto_mhs(
            @Field("nama") String nama,
    ...
    @FormUrlEncoded
    @POST("/api/progmob/mhs/updatefotomhs")
    Call<DefaultResult> update_foto_mhs(
            @Field("id") String id,
            @Field("nama") String nama,
            @Field("nim") String nim,
            @Field("alamat") String alamat,
